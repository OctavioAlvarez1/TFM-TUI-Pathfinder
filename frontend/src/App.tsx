          ...
          <Box sx={{
            ...
            {currentView === 'home' && (
              <>
                ...
                {/* Wave decorations */}
                <Box sx={{ position: 'absolute', bottom: -10, left: 0, width: '200%', height: 110,
                           animation: `${waveForward} 22s linear infinite`, pointerEvents: 'none', zIndex: 0 }}>
                  <svg viewBox="0 0 2880 110" preserveAspectRatio="none" style={{ width: '100%', height: '100%' }}>
                    <path d="M0,55 C240,100 480,10 720,55 C960,100 1200,10 1440,55 C1680,100 1920,10 2160,55 C2400,100 2640,10 2880,55 L2880,110 L0,110 Z" fill="rgba(255,255,255,0.22)" />
                  </svg>
                </Box>
                <Box sx={{ position: 'absolute', bottom: -6, left: 0, width: '200%', height: 75,
                           animation: `${waveBack} 15s linear infinite`, pointerEvents: 'none', zIndex: 0 }}>
                  <svg viewBox="0 0 2880 75" preserveAspectRatio="none" style={{ width: '100%', height: '100%' }}>
                    <path d="M0,38 C360,75 720,0 1080,38 C1440,75 1800,0 2160,38 C2520,75 2880,0 2880,38 L2880,75 L0,75 Z" fill="rgba(255,255,255,0.30)" />
                  </svg>
                </Box>
                <Box sx={{ position: 'absolute', bottom: -4, left: 0, width: '200%', height: 48,
                           animation: `${waveForward} 10s linear infinite`, pointerEvents: 'none', zIndex: 0 }}>
                  <svg viewBox="0 0 2880 48" preserveAspectRatio="none" style={{ width: '100%', height: '100%' }}>
                    <path d="M0,24 C480,48 960,0 1440,24 C1920,48 2400,0 2880,24 L2880,48 L0,48 Z" fill="rgba(255,255,255,0.20)" />
                  </svg>
                </Box>
